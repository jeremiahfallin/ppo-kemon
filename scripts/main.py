...
async def main():
    ...
    train_env = SimpleRLPlayer(
        battle_format="gen8randombattle", opponent=opponent, start_challenging=True, server_configuration=LocalhostServerConfiguration
    )
    opponent = RandomPlayer(battle_format="gen8randombattle", server_configuration=LocalhostServerConfiguration)
